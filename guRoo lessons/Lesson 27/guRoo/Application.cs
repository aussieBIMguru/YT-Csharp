...
namespace guRoo
{
    ...
    public class Application: IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication uiCtlApp)
        {
            ...
            // Add import pulldown
            var pulldownImport = panelTools.Ext_AddPulldownButton("Import", "guRoo.Cmds_Import");

            // Add pushbuttons to import
            pulldownImport.Ext_AddPushButton<guRoo.Cmds_Import.Cmd_CreateSheets>("Import sheets from Excel", availability: gAva.Project);

            // Add export pulldown
            var pulldownExport = panelTools.Ext_AddPulldownButton("Export", "guRoo.Cmds_Export");

            // Add pushbuttons to export
            pulldownExport.Ext_AddPushButton<guRoo.Cmds_Export.Cmd_SheetsPdf>("Export sheets to PDF", availability: gAva.Project);
            pulldownExport.Ext_AddPushButton<guRoo.Cmds_Export.Cmd_SheetsDwg>("Export sheets to DWG", availability: gAva.Project);

            // Add testing pulldown
            var pulldownTesting = panelTools.Ext_AddPulldownButton("Testing", "guRoo.Cmds_Testing");

            // Add pushbuttons to testing
            pulldownTesting.Ext_AddPushButton<guRoo.Cmds_Testing.Cmd_Testing>("Testing", availability: gAva.Project);
