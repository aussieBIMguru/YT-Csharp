...
namespace guRoo
{
    ...
    public class Application: IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication uiCtlApp)
        {
            ...
            // Add button to panel
            var buttonTest = panelGeneral.Ext_AddPushButton("Button",
                "guRoo.Cmds_Button.Cmd_Button",
            ...
            pulldownRevision.Ext_AddPushButton("BulkRev",
                "guRoo.Cmds_Revision.Cmd_BulkRev",
            ...
            pulldownWorkset.Ext_AddPushButton("Create workset(s)",
                "guRoo.Cmds_Workset.Cmd_Create",
