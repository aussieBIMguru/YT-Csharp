...
namespace guRoo.Extensions
{
    public static class Document_Ext
    {
        ...
        /// <param name="includePlaceholders">Include placeholder sheets.</param>
        /// <returns>A FormResult object</returns>
        public static gFrm.FormResult Ext_SelectSheets(this Document doc, string title = null,
        ...
        /// <param name="sorted"></param>
        /// <returns></returns>
        public static gFrm.FormResult Ext_SelectWorksets(this Document doc, string title = null,
