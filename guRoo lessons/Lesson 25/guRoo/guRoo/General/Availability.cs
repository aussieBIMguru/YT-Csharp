...
namespace guRoo
{
    public static class Availability
    {
        ...
        public static class AvailabilityNames
        {
            ...
            public static string Selection_SheetsOnly { get { return $"{PATH_AVAILABILITY}+Selection_SheetsOnly"; } }
        }
        ...
        // Availability - Do we have just sheets selected
        private class Selection_SheetsOnly : IExternalCommandAvailability
        {
            public bool IsCommandAvailable(UIApplication uiApp, CategorySet selectedCategories)
            {
                if (uiApp.ActiveUIDocument is UIDocument uiDoc)
                {
                    ...
                    return selectedCategories.Contains(Category.GetCategory(uiDoc.Document, BuiltInCategory.OST_Sheets));
                }
                else
                {
                    return false;
